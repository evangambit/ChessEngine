...
class ShardedMatrixDataset(tdata.IterableDataset):
  ...
  def __iter__(self):
    ...
    while True:
      ...
      yield tuple([torch.from_numpy(y[idx].copy()) for y in s])
...
varnames = [
  ...
  "ROOKS_X_QUEENS_2",
  "KNOWN_DRAW",
  "OUR_ROYAL_FORKS_THREATS",
  "THEIR_ROYAL_FORKS_THREATS",
  "OUR_COMMON_FORK_THREATS",
  "THEIR_COMMON_FORK_THREATS",
  "SIMULTANEOUS_THREATS_AGAINST_US_1",
  "SIMULTANEOUS_THREATS_AGAINST_US_2",
  "SIMULTANEOUS_THREATS_AGAINST_US_3",
  "SIMULTANEOUS_THREATS_AGAINST_US_4",
  "TRAPPED_KNIGHTS",
  "TRAPPED_BISHOPS",
]